      ...
      {!hasProvider() && (
        <p className="small dim" style={{ marginTop: '.9rem', marginBottom: 0 }}>
          ...
          the result{(links && (links.Wallet || links.wallet))
            ? <>: <a href={links.Wallet || links.wallet} target="_blank" rel="noopener noreferrer">the web wallet</a>&rsquo;s Sign tab signs it with your staking key, and so does Ambra&rsquo;s Sign screen on a phone</>
            : ''}.
